...
LLMatOrd simple5x5(){
   ...
   lles[3].row = 3; lles[3].next = 3; lles[3].val = 1;
   lles[4].row = 1; lles[4].next = 2; lles[4].val = 1;
   lles[5].row = 2; lles[5].next = 3; lles[5].val = 1;
   lles[6].row = 3; lles[6].next = 4; lles[6].val = 1;
   lles[7].row = 4; lles[7].next = 4; lles[7].val = 1;
   lles[8].row = 2; lles[8].next = 2; lles[8].val = 1;
   lles[9].row = 3; lles[9].next = 3; lles[9].val = 1;
   lles[10].row = 4; lles[10].next = 4; lles[10].val = 1;
   llmat.lles = lles;
   return llmat;
}