...
do
    ...
    do
	   ...
	   perf report --stdio --dsos=main -i "./log/perf_v${V}_e${E}.data" | tee -a "./log/pf_v${V}_e${E}.txt"
           perf annotate --stdio --dsos=main -i "./log/perf_v${V}_e${E}.data"  | tee -a "./log/p_v${V}_e${E}.txt"
