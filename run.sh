...
edge=(100 500 1000 2000 5000 8000 10000 20000)
...
do
    ...
    do
        ...
        then
            ...
            3>>"./log/cache_log.txt" perf stat -e LLC-loads,LLC-load-misses,LLC-stores,LLC-store-misses,dTLB-loads,dTLB-load-misses,dTLB-stores,dTLB-store-misses,iTLB-loads,iTLB-load-misses --log-fd 3 --append -d ./build/test/test_once $V $E | tee -a "./log/cache_log.txt"

            echo "Start test. V = ${V}, E = ${E}" | tee -a "./log/flops_log.txt"
            3>>"./log/flops_log.txt" perf stat -e r5301c7,r5302c7 --log-fd 3 --append -d ./build/test/test_once $V $E | tee -a "./log/flops_log.txt"
